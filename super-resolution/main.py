...
def get_arguments():
    ...
    parser.add_argument('--dsd-weight', default=0, type=float, help='dsd-weight (default: 0)')
    ...
    parser.add_argument('--recurrent-scales', default=[0.5], type=float, nargs='+', help='recurrent scales (e.g 0.25 0.5)')
