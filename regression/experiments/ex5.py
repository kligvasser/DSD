...
def get_arguments():
    parser = argparse.ArgumentParser(description='PieAPP-noref-MA')
...
if __name__ == "__main__":
    ...
    eng.cd('/home/klig/Dropbox/python/projects/utils/prim18/utils/sr-metric-master')
    eng.addpath('./external/matlabPyrTools', './external/randomforest-matlab/RF_Reg_C')
    ...
    for csv_file in csv_list:
        ...
        for j, data in enumerate(loader):
            ...
            score_a = float(eng.quality_predict(image_a))

            image_b = eng.imread(b_path)
            score_b = float(eng.quality_predict(image_b))

            our = 1. / (1. + math.exp(args.bandwidth * (score_b - score_a)))
